######
gbp <- function(x, w, covariates, mean.PriorDist, model, intercept, Alpha, n.IS, trial.scale, normal.CI = FALSE) UseMethod("gbp")
######
...
######
  res <- switch(model, 
       gaussian = gr(x, w, X = covariates, mu = mean.PriorDist, Alpha = Alpha, intercept = intercept, normal.CI), 
