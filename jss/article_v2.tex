...
We illustrate our estimation procedure equipped with the adjustment for density maximization (hereafter ADM) \citep{carl1988, morris1997, tang2011}, a distributional approximation to a Pearson family distribution via derivatives, using the Binomial and Poisson hierarchical models. The ADM procedure for the Gaussian hierarchical model used in  \pkg{Rgbp} has been well-documented in \cite{kelly2014advances}.
...
%Also, \cite{morris1997} used the Poisson model empirically showed that their covariance in observed information matrix of the Poisson-Gamma model was close to 0 in a small sample setting.
