...
So, its unbiased variance estimator  for $Var(\bar{I}_{j})$ is simply the sample variance of indicators over the number of simulations.
\begin{equation}
...
Rao-Blackwellization improves accuracy of an unbiased estimator by taking more information (sufficient statistic) into consideration. Based on this idea, we use $E(I^{(i)}_{j}\vert y^{(i)}_{j}, A, \beta$), where $A$ and $\beta$ are given and $y^{(i)}_{j}$ is the sufficient statistic for the $j$-th group in the $i$-th pseudo-dataset. 
...
\end{CodeInput}
\begin{CodeOutput}
 [1] 0.955 0.955 0.955 0.955 0.955 0.955 0.955 0.955 0.955 0.954 0.954 0.955 
[13] 0.954 0.955 0.954 0.954 0.954 0.955 0.954 0.954 0.954 0.954 0.954 0.954 
[25] 0.953 0.954 0.953 0.953 0.954 0.952 0.952
\end{CodeOutput}
\end{CodeChunk}
...
\end{CodeInput}
\begin{CodeOutput}
 [1] 0.960 0.953 0.956 0.952 0.957 0.957 0.960 0.949 0.949 0.944 0.951 0.947 
[13] 0.949 0.958 0.958 0.959 0.953 0.954 0.953 0.955 0.956 0.952 0.953 0.959 
[25] 0.945 0.945 0.953 0.946 0.953 0.948 0.955
\end{CodeOutput}
\end{CodeChunk}
...
\end{CodeInput}
\begin{CodeOutput}
 [1] 0.0016 0.0016 0.0014 0.0013 0.0013 0.0013 0.0013 0.0013 0.0013 0.0013 0.0012 
[12] 0.0012 0.0012 0.0011 0.0011 0.0011 0.0011 0.0011 0.0011 0.0011 0.0011 0.0010
...
\end{CodeInput}
\begin{CodeOutput}
 [1] 0.0062 0.0067 0.0065 0.0068 0.0064 0.0064 0.0062 0.0070 0.0070 0.0073 0.0068 
[12] 0.0071 0.0070 0.0063 0.0063 0.0063 0.0067 0.0066 0.0067 0.0066 0.0065 0.0068
[23] 0.0067 0.0063 0.0072 0.0072 0.0067 0.0072 0.0067 0.0070 0.0066
\end{CodeOutput}
\end{CodeChunk}

Taking the first hospital as an example, the variance of RB unbiased coverage estimate is about 15 times smaller than that of simple one. It means that 1,000 RB unbiased coverage estimates are as precise as 15,000 simple unbiased coverage estimates in terms of estimating true coverage probability for the first hospital.
...
\end{CodeInput}
\begin{CodeOutput}
 [1] 0.964 0.958 0.964 0.960 0.956 0.959 0.958 0.966
\end{CodeOutput}
\end{CodeChunk}
\begin{CodeChunk}
\begin{CodeInput}
...
\end{CodeInput}
\begin{CodeOutput}
 [1] 0.0014 0.0013 0.0016 0.0014 0.0014 0.0012 0.0012 0.0017
\end{CodeOutput}
\end{CodeChunk}
...
As in the previous examples in Sections \ref{sec:ex:hosp} and \ref{sec:ex:8schools} to check the level of trust in these interval estimates a method check can be undertaken by assuming the estimates, $\hat{r}$ (=112.95) and $\hat{\beta}~(=(-1.194, ~0.389)^{T})$, are true values. For reference, to do the method check at different true values additional arguments can be specified in the coverage function.
...
%$
\begin{CodeOutput}
 [1] 0.973 0.973 0.974 0.971 0.971 0.973 0.972 0.973 0.972 0.973 0.971 0.973 
[13] 0.971 0.972 0.974 0.972 0.972 0.973
\end{CodeOutput}
\end{CodeChunk}
\begin{CodeChunk}
\begin{CodeInput}
...
\end{CodeInput}
\begin{CodeOutput}
 [1] 0.0010 0.0011 0.0011 0.0013 0.0012 0.0011 0.0012 0.0011 0.0012 0.0010 
[11] 0.0013 0.0012 0.0013 0.0013 0.0010 0.0010 0.0010 0.0010
\end{CodeOutput}
\end{CodeChunk}
...
A benefit of \pkg{Rgbp} is that it produces non-random output, unlike most MCMC methods,  and so results can easily be reproduced and compared across studies. In addition to being a standalone analysis tool the package can be used as an aid or a tool in a broader estimation procedure. Such as being used to
...
\item for frequentist procedure checking (via bootstrapping).
