...
\pkg{Rgbp} includes this dataset and can be called by typing \code{data(schools)} on \proglang{R}.
...
This dataset is also included in the package and can be called by \code{data(hospital)} on \proglang{R}.
...
This dataset is also a part of the package and can be called on \proglang{R} by \code{data(baseball)}.
