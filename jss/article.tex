...
As an alternative to other derivative based estimation methods such as MLE and REML \pkg{Rgbp} utilizes ADM. In addition to be benefits outlined in this paper ADM based models typically have non-random output and so the model can easily be reproduced and compared. ADM can also be used 
